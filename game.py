...
class Game:
    ...
    def display_menu(self):
       ...
       while menu_running:
            ...
            button_spacing = 100
            play_button.button_x = (screen_width - play_button.button_width) // 2
    ...
    def draw_pause_screen(self):
        ...
        sub_message_rect = sub_message.get_rect(center=(screen_width // 2, screen_height // 2))
    ...
    def display_game_completed_screen(self):
        ...
        while completed:
            ...
            message = self.font.render("¡Congratulations! You won the game.", True, white)
            message_rect = message.get_rect(center=(screen_width // 2, screen_height // 2 - 200))
            ...
            button_spacing = 100
            restart_button.button_x = (screen_width - restart_button.button_width) // 2
            restart_button.button_y = (
                screen_height - restart_button.button_height) // 2 - button_spacing
            ranking_button.button_x = (screen_width - ranking_button.button_width) // 2
            ranking_button.button_y = (
                screen_height - ranking_button.button_height) // 2 
            save_button.button_x = (screen_width - save_button.button_width) // 2
    ...
    def ranking_menu(self):
        while self.state == "ranking":
            ...
            score_message = font.render(f"Your score: {self.total_points}", True, white)
            score_rect = score_message.get_rect(center=(screen_width // 2, screen_height // 2))
            ...
            for puntaje in puntajes:
                ...
                puntaje_rect = puntaje_renderizado.get_rect(center=(screen_width // 2, y))
